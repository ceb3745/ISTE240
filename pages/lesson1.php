...
include($Path.'assets/inc/nav.php'); ?>
    ...
    <main>
        ...
        <p>
            ...
            smaller text than the other headings so that it looks nice and easy to read. Content goes here in a smaller text than the other headings so that it looks nice and 
            easy to read. Content goes here in a smaller text than the other headings so that it looks nice and easy to read. Content goes here in a smaller text than the other
            headings so that it looks nice and easy to read. Content goes here in a smaller text than the other headings so that it looks nice and easy to read. Content goes
            here in a smaller text than the other headings so that it looks nice and easy to read. Content goes here in a smaller text than the other headings so that it looks
        ...
        <p>
            ...
            smaller text than the other headings so that it looks nice and easy to read. Content goes here in a smaller text than the other headings so that it looks nice and 
            easy to read. Content goes here in a smaller text than the other headings so that it looks nice and easy to read. Content goes here in a smaller text than the other 
            headings so that it looks nice and easy to read. Content goes here in a smaller text than the other headings so that it looks nice and easy to read. Content goes here 
